    ...
    return (
      <div>
        ...
        <ul>
          ...
          <p>At the end of turn 2 a voting starts where players vote on who they think the traitor is. If the traitor is the mosted voted player then the agents win, otherwise the traitor wins.</p>
        </ul>
