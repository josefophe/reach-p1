      ...
      <div class>
        <h2 class>Game Rules</h2>
          <div>
            ...
            <p class>At the end of turn 2 a voting starts where players vote on who they think the traitor is. If the traitor is the most voted player then the agents win, otherwise the traitor wins.</p>
          </div>
