...
exports.FundAccount = class extends React.Component {
  render() {
    ...
    return (
      <div className={CSSPageRule.mod}>
        <h2 className={CSSPageRule.mod}>Game Rules</h2>
          <div>
            <p className={CSSPageRule.mod}>
            ...
            <p className={CSSPageRule.mod}>At the end of turn 2 a voting starts where players vote on who they think the traitor is. If the traitor is the most voted player then the agents win, otherwise the traitor wins.</p>
          </div>
