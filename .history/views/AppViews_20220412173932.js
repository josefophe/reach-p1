...
exports.FundAccount = class extends React.Component {
  render() {
    ...
    return (
      <div className={CSSPageRule.modal}>
        <h2 className={CSSPageRule.modal}>Game Rules</h2>
          <div>
            <p className={CSSPageRule.modal}>
            ...
            <ul className={CSSPageRule.modal}>
            ...
            <p className={CSSPageRule.modal}>At the end of turn 2 a voting starts where players vote on who they think the traitor is. If the traitor is the most voted player then the agents win, otherwise the traitor wins.</p>
          </div>
