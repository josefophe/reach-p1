  ...
  render() {
    ...
    return (
      <div className={rule.modal}>
        <h2 className={rule.modal}>Game Rules</h2>
          <div>
            <p className={rule.modal}>
            ...
            <p className={rule.modal}>At the end of turn 2 a voting starts where players vote on who they think the traitor is. If the traitor is the most voted player then the agents win, otherwise the traitor wins.</p>
          </div>
