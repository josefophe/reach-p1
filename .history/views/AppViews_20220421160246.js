        ...
        <div className={rule.modal}>
          <h2 className={rule.modal_header}>Game Rules</h2>
            <div>
              ...
              <p className={rule.modal_text}>At the end of turn 3 a voting starts where players vote on who they think the traitor is. If the traitor is the most voted player then theagents win, otherwise the traitor wins.
              </p>
            </div>
        </div>
