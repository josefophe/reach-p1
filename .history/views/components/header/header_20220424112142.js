...
// const ioClient = io('http://localhost:4000')
 ...
 function Header({account,getWalletInfo}) {
   ...
   useEffect(()=>{
    ...
    //   console.log('link to io',payload)
    // })
   })
    ...
    /**
     * Get encrypted wallet information
     */
    ...
    return <div className={styles.header}>
        <div className={styles.headerBox}>
            ...
            {/* <div className={styles.buyView}>
               <Button type={'primary'} onClick={() => { emitIoMessageHandle() }}>{'io test'}</Button>
            </div> */}
